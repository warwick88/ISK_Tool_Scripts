 /****** Object:  StoredProcedure [dbo].[Csp_MapKalamazooLabObservationsWithFlowSheet]    Script Date: 16-01-2018 17:24:12 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Csp_MapKalamazooLabObservationsWithFlowSheet]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Csp_MapKalamazooLabObservationsWithFlowSheet]
GO
...
GO
 ...
 CREATE PROCEDURE [dbo].[Csp_MapKalamazooLabObservationsWithFlowSheet] @ClientOrderId INT  
...
Jan 22 2021   Bibhu  Changed the SP name from csp_CreateLabOrderFlowsheet to csp_CreateKalamazooLabOrderFlowsheet  																			 
			  KCMHSAS - Support # 1629
Jan 22 2021   Bibhu  Renamed SP From Csp_MapLabObservationsWithFlowSheet to Csp_MapKalamazooLabObservationsWithFlowSheet  
			  KCMHSAS - Support # 1629
...
BEGIN  
 ...
 BEGIN CATCH  
  ...
  SET @Error = CONVERT(VARCHAR(4000), ERROR_MESSAGE()) + '*****' + ISNULL(CONVERT(VARCHAR, ERROR_PROCEDURE()), 'Csp_MapKalamazooLabObservationsWithFlowSheet')  
