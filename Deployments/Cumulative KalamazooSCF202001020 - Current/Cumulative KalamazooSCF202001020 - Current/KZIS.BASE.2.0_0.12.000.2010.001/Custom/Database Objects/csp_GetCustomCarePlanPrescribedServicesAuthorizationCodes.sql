IF EXISTS (
	...
	DROP PROCEDURE [dbo].[csp_GetCustomCarePlanPrescribedServicesAuthorizationCodes] --5,323,'G'
GO
...
BEGIN
	BEGIN TRY
		...
		LEFT JOIN CustomCarePlanPrescribedServices CDCP ON AC.AuthorizationCodeId = CDCP.AuthorizationCodeId
