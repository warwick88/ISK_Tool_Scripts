...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','GeneralAppearance'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','GeneralPoorlyAddresses'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','Speech'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','SpeechIncreased'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','PsychiatricNoteExamLanguage'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','LanguageDifficultyNaming'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','MoodAndAffect'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','MoodHappy'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','AffectEuthymic'
		,'FROM CustomDocumentMentalStatusExams WHERE DocumentVersionId=@DocumentVersionId AND MoodAndAffect=''A'' AND
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','AttensionSpanAndConcentration'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','AttensionPoorConcentration'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','ThoughtContentCognision'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','TPDisOrganised'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','Associations'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','AssociationsLoose'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','AbnormalorPsychoticThoughts'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','PsychosisOrDisturbanceOfPerception'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','PDCurrentSuicideIdeation'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','PDCurrentSuicidalPlan'
		,'FROM CustomDocumentMentalStatusExams WHERE DocumentVersionId=@DocumentVersionId AND 
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','PDCurrentSuicidalIntent'
		,'FROM CustomDocumentMentalStatusExams WHERE DocumentVersionId=@DocumentVersionId AND 
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','PDMeanstocarry'
		,'FROM CustomDocumentMentalStatusExams WHERE DocumentVersionId=@DocumentVersionId AND 
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','PDCurrentHomicidalIdeation'
		,'FROM CustomDocumentMentalStatusExams WHERE DocumentVersionId=@DocumentVersionId AND 
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','PDCurrentHomicidalPlans'
		,'FROM CustomDocumentMentalStatusExams WHERE DocumentVersionId=@DocumentVersionId AND 
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','PDCurrentHomicidalIntent'
		,'FROM CustomDocumentMentalStatusExams WHERE DocumentVersionId=@DocumentVersionId AND 
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','PDMeansToCarryNew'
		,'FROM CustomDocumentMentalStatusExams WHERE DocumentVersionId=@DocumentVersionId AND 
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','Orientation'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','OrientationPerson'
...
IF NOT EXISTS (
		SELECT * FROM dbo.DocumentValidations
		WHERE DocumentCodeId = @DocumentCodeId AND Active = 'Y' AND ColumnName = 'OrientationDescribeSituation'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','OrientationDescribeSituation'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','OrientationFullName'
		,'FROM CustomDocumentMentalStatusExams WHERE DocumentVersionId=@DocumentVersionId AND ( Orientation=''A'' OR Orientation=''W'')  AND
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','OrientationEvidencedPlace'
		,'FROM CustomDocumentMentalStatusExams WHERE DocumentVersionId=@DocumentVersionId AND ( Orientation=''A'' OR Orientation=''W'')  AND
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','OrientationFullDate'
		,'FROM CustomDocumentMentalStatusExams WHERE DocumentVersionId=@DocumentVersionId AND ( Orientation=''A'' OR Orientation=''W'')  AND
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','FundOfKnowledge'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','FundOfKnowledgeCurrentEvents'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','FundEvidenceVocabulary'
		,'FROM CustomDocumentMentalStatusExams WHERE DocumentVersionId=@DocumentVersionId AND FundOfKnowledge=''A''  AND 
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','InsightAndJudgement'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','InsightAndJudgementStatus'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','Memory'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','MemoryImmediate'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','MemoryImmediateEvidencedBy'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','MemoryRecent'
		,'FROM CustomDocumentMentalStatusExams WHERE DocumentVersionId=@DocumentVersionId AND Memory=''A''   AND  
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','MemoryRecentEvidencedBy'
		,'FROM CustomDocumentMentalStatusExams WHERE DocumentVersionId=@DocumentVersionId AND (Memory=''A'' OR Memory=''W'')  AND  
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','MemoryRemote'
		,'FROM CustomDocumentMentalStatusExams WHERE DocumentVersionId=@DocumentVersionId AND Memory=''A''   AND  
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','MemoryRemoteEvidencedBy'
		,'FROM CustomDocumentMentalStatusExams WHERE DocumentVersionId=@DocumentVersionId AND (Memory=''A'' OR Memory=''W'')  AND  
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','MuscleStrengthorTone'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','MuscleStrengthorToneAtrophy'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','GaitandStation'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','GaitandStationRestlessness'
...
BEGIN
	...
	VALUES (
		'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','ReviewWithChanges'
...
INSERT INTO [DocumentValidations] (
	...
	VALUES ( 'Y',@DocumentCodeId,NULL,'Mental Status',@TabOrder,'CustomDocumentMentalStatusExams','InsightEvidenceAwareness'
